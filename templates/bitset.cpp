...
// the n must be const
bitset<10>b=5;
cout<<b<<el;// print the binary presention to this num

cout<<b.count()<<el;// count ones
//cout<<b.reset()<<el;// all bits be 0
cout<<b[0]<<el; // to know the frist bit 1 or 0
cout<<b.to_ullong()<<el; // num in decimal
